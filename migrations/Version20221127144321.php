 ...
 */
final class Version20221127144321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entretien CHANGE evaluation evaluation_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entretien CHANGE evaluation_id evaluation INT DEFAULT NULL');
